...
export class Base1772456536830 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "swap" ADD "has_been_processed" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "mints" ADD "has_been_processed" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "burn" ADD "has_been_processed" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1bb0a599979b86b5cf7b98d2a6" ON "swap" ("has_been_processed") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a032ee2382503df52124f96cac" ON "mints" ("has_been_processed") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f4993be039b97f7abae1669c78" ON "burn" ("has_been_processed") `,
    );
  }
